...
export function hashU32(/** @type {number} */ a) {
    a = a | 0;
...
export function readU64(/** @type {number[] | Uint8Array} */ b, /** @type {number} */ n) {
    var x = 0;
    x |= b[n++] << 0;
    x |= b[n++] << 8;
    x |= b[n++] << 16;
...
export function readU32(/** @type {number[] | Uint8Array} */ b, /** @type {number} */ n) {
    var x = 0;
    x |= b[n++] << 0;
    x |= b[n++] << 8;
    x |= b[n++] << 16;
...
export function writeU32(/** @type {number[] | Uint8Array} */ b, /** @type {number} */ n, /** @type {number} */ x) {
    b[n++] = (x >> 0) & 0xff;
    b[n++] = (x >> 8) & 0xff;
    b[n++] = (x >> 16) & 0xff;
    b[n++] = (x >> 24) & 0xff;
...
export function imul(/** @type {number} */ a, /** @type {number} */ b) {
    var ah = a >>> 16;
    var al = a & 65535;
    var bh = b >>> 16;
    var bl = b & 65535;
